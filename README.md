...
- [ ] **Use of different types of selectors including element, class, ID, and pseudo selectors** - Pseudo selector in form of new nav a:hover. class selector with the login button onindex.html
